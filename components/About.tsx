...
const About = () => {
  ...
  return (
    <div className="fixedsys mt-28 flex min-h-screen w-full flex-col space-y-10 px-4 md:mt-0 md:flex-row md:space-x-10 md:space-y-8 md:px-10">
      <div className="flex justify-center md:flex-1 md:justify-end">
        <div className="flex flex-col items-center justify-center lg:max-w-[70vh]">
          ...
          <div className="text-md mt-4 w-full text-center md:text-lg lg:text-2xl">
            <div className="w-72 whitespace-pre-line break-words md:w-auto md:max-w-xl">
